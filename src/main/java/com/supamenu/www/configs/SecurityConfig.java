...
public class SecurityConfig {
    ...
    private static final String[] AUTH_WHITELIST = {"/swagger-ui/**", "/swagger-ui.html", "/v3/api-docs/**", "/api/documents/download/**", "/api/v1/auth/**", "/api/v1/profile/request-reset-password"};
